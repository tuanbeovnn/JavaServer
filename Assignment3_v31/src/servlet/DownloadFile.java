...
public class DownloadFile extends HttpServlet {
	...
	public void init() {
		...
		downloadDir = this.getServletContext().getRealPath("download_files")+ "/download_files/";
//		downloadDir = this.getServletContext().getInitParameter("download-dir") + separator;
		
//		downloadDir = "/Users/tuannguyen/eclipse-workspace/Assignment3_v31/WebContent/download_files" + separator;
	...
	private void sendHTMLErrorMessage(HttpServletRequest request, HttpServletResponse response, String error) {
		...
		try {
			...
			out.println("<p><b>File Downloaded:</b> " + error);
			out.println("<p><a href='index.html'>Back</a>");
			out.println("</body>");
			out.println("</html>");
			out.close();
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			inputStream.close();
			FileOutputStream out = new FileOutputStream(downloadDir + file);
			out.write(data);
			out.flush();
			out.close();
