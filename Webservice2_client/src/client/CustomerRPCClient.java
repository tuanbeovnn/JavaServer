...
public class CustomerRPCClient {
	...
	public static void menu() {
		...
		System.out.println("5. Print Customer Shopping Amount");
	...
	public static void main(String[] args1) throws AxisFault {
		...
		EndpointReference targetEPR = new EndpointReference("http://localhost:8080/axis2/services/t2_customerService");
		...
		while (true) {
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("Enter lower bound and upper bound as: lower upper");
        		String s = new Scanner(System.in).nextLine();
        		float lower = Float.parseFloat(s.split(" ")[0]);
        		float upper = Float.parseFloat(s.split(" ")[1]);
        		QName opGetCustomerAmount = new QName("http://service.customer.ws", "getCustomerShopping");
        		Object[] opGetCustomerArgs1 = new Object[] { lower, upper };
        		Class[] returnTypes1 = new Class[] { Customer[].class };
        		Object[] response1 = serviceClient.invokeBlocking(opGetCustomerAmount, opGetCustomerArgs1, returnTypes1);
        		Customer[] result = (Customer[]) response1[0];
